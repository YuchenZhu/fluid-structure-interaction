...
EE1_method(method,k) = e1;
E2_method(method,k) = e2;
end
...
figure(4)
loglog(timesteps,EE1_method(1,:),'-rp', timesteps,E2_method(1,:),'-gp',timesteps,EE1_method(2,:),'-bp',timesteps,E2_method(2,:),'-cp',timesteps,EE1_method(3,:),'-mp',timesteps,E2_method(3,:),'-yp');grid on;
title(['Assmble of errors from different methods ' ]);
ylabel('Error');xlabel('\Delta t');
legend();
